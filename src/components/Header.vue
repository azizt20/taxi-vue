<template>
  <div class="Header ">
    <div></div>
    <row>
      <router-link class="link" style="padding: 5px 10px; margin: auto 20px" to="/"> {{$t('Оформить заказ')}}</router-link>
      ...
      <router-link class="link" style="padding: 5px 10px; margin: auto 20px" to="orders"> {{$t('Информация о заказах')}}
      </router-link>
