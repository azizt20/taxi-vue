<template>
  <div class="Header ">
    ...
    <a-row>
      ...
      <router-link class="link" style="padding: 5px 10px; margin: auto 20px" to="edit">
        {{ $t('Редактировать локации') }}
      </router-link>
      <router-link class="link" style="padding: 5px 10px; margin: auto 20px" to="orders">
        {{ $t('Информация о заказах') }}
      </router-link>
      <router-link class="link" style="padding: 5px 10px; margin: auto 20px" to="panel"> {{ $t('Контроль панель') }}
      </router-link>
      <router-link class="link" style="padding: 5px 10px; margin: auto 20px" to="driver"> {{ $t('Панель водителя') }}
      </router-link>
